...
<html>
    <head>
        <title>Update Staff | Hotel Sri Batik</title>
    ...
    <body>
        ...
        <?php
            ...
            // retrieve staff data using staff name
            $staffSQL = "SELECT * FROM STAFF WHERE STAFFNAME = '$staffName'";
            $staffResult = mysqli_query($connect, $staffSQL);
        ...
        <main>
            ...
            <div class="wrapper">
                ...
                <form action="update_function.php" method="POST" class="form">
                   <div class="inputfield">
                      <label>Staff Name</label>
                      <input type="text" class="input" name="staffName" value="<?php echo $row['STAFFNAME']; ?>" required>
                   </div>
                   <div class="inputfield">
                      <label>Full Name</label>
                      <input type="text" class="input" name="fullName" value="<?php echo $row['FULLNAME']; ?>" required>
                   </div>
                    <div class="inputfield">
                      <label>Email Address</label>
                      <input type="text" class="input" name="staffEmail" value="<?php echo $row['EMAIL']; ?>" required>
                   </div> 
                   <div class="inputfield">
                      <label>Password</label>
                      <input type="password" class="input" name="staffPassword" required>
                   </div> 
                    <input type="hidden" value="editStaff" name="formType">
                  <div class="inputfield">
