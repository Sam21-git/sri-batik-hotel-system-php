...
<html>
    <head>
        <title>Sales Report of Hotel Sri Batik</title>
    ...
    <body>
        ...
        <main>
        <h1>Overall Sales</h1>
            <table class="saletable" style="width: 70%">
                <tr>
                    <th>No.</th>
                    <th>Name</th>
                    <th>Room</th>
                ...
                <?php
                    ...
                    $counter = 1;
                    $totalSale = 0.00;
                    // loop to show all customer
                    while ($row = mysqli_fetch_array($saleResult)) {
                ?>
                <tr>
                    <td><?php echo $counter++ ?></td>
                    <td><?php echo $row['PAYCUSTNAME']; ?></td>
                    <td><?php echo $row['PAYROOM']; ?></td>
                    <td><?php echo $row['PAYPERIOD']; ?></td>
                    <td><?php echo $row['PAYDATE']; ?></td>
                    <td><?php echo $row['PAYTIME']; ?></td>
                    <td><?php echo $row['PAYTOTAL']; ?></td>
                </tr>
                <?php 
                    $totalSale += $row['PAYTOTAL'];
                    } 
                ?>
                <tr>
