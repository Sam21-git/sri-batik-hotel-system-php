...
<html>
    <head>
        <title>Update Admin | Hotel Sri Batik</title>
    ...
    <body>
        ...
        <?php
            ...
            // retrieve admin data using admin name
            $adminSQL = "SELECT * FROM ADMIN WHERE ADMINNAME = '$adminName'";
            ...
            <div class="wrapper">
                ...
                <form action="update_function.php" method="POST" class="form">
                   <div class="inputfield">
                      ...
                      <input type="text" class="input" name="adminName" value="<?php echo $row['ADMINNAME']; ?>" required>
                   </div>
                   <div class="inputfield">
                    ...
                    <div class="inputfield">
                      ...
                      <input type="text" class="input" name="adminEmail" value="<?php echo $row['EMAIL']; ?>" required>
                   </div> 
                   <div class="inputfield">
                      <label>Password</label>
                      <input type="password" class="input" name="adminPassword" required>
                   </div> 
                    <input type="hidden" value="editAdmin" name="formType">
                  <div class="inputfield">
