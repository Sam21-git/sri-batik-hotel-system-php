...
<html>
    <head>
        <title>Room of Hotel Sri Batik</title>
            ...
            <div class="room__container">
                <?php
                    ...
                    while ($row = mysqli_fetch_array($roomResult)) {
                        ...
                        // if room is available, room status = available
                ...
                ?>
                        <div class="room">
                            <span class="room__number">
                                <?php if ($row['ISAVAILABLE'] == true) { ?>
                                    <span style="color: green"><b><?php echo $row['ROOMNUMBER']; ?></b></span>
                                <?php } else { ?>
                                    <span style="color: red"><b><?php echo $row['ROOMNUMBER']; ?></b></span>
                                <?php } ?>
                            </span>
                            <div class="room__detail">
                                <span class="room__type"><?php echo $row['ROOMTYPE']; ?></span>
                                <span class="room__price">
                                    RM <?php echo $row['ROOMPRICE']; ?>
                                </span>
                                <span class="room__status">
                                    <?php if ($row['ISAVAILABLE'] == true) { ?>
                                        <span style="color: green"><b><?php echo $roomStatus; ?></b></span>
                                    <?php } else { ?>
                                        <span style="color: red"><b><?php echo $roomStatus; ?></b></span>
                                    <?php } ?>
                                </span>
                            </div>
                        </div>
