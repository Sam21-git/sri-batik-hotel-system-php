...
<html>
    <head>
        <title>Admin Register | Hotel Sri Batik</title>
    ...
    <body>
        ...
        <main>
            ...
            <div class="wrapper">
                ...
                <form action="register_function.php" method="POST" class="form">
                   <div class="inputfield">
                      <label>User Name</label>
                      <input type="text" class="input" name="adminName" required>
                   </div>
                   <div class="inputfield">
                    ...
                    <div class="inputfield">
                      ...
                      <input type="text" class="input" name="adminEmail">
                   </div>  
                   
                  <div class="inputfield">
                      <label>Password</label>
                      <input type="password" class="input" name="adminPassword">
                   </div> 
                    <input type="hidden" value="registerAdmin" name="formType">
                  <div class="inputfield">
