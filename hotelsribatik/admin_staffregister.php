...
<html>
    <head>
        <title>Staff Register | Hotel Sri Batik</title>
            ...
            <div class="wrapper">
                ...
                <form action="register_function.php" method="POST" class="form">
                   <div class="inputfield">
                      ...
                      <input type="text" class="input" name="staffName" required>
                   </div>
                   <div class="inputfield">
                    ...
                    <div class="inputfield">
                      ...
                      <input type="text" class="input" name="staffEmail">
                   </div>  
                   
                  <div class="inputfield">
                      <label>Password</label>
                      <input type="password" class="input" name="staffPassword">
                   </div> 
                    <input type="hidden" value="registerStaff" name="formType">
                  <div class="inputfield">
