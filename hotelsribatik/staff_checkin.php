...
<html>
    <head>
        <title>Check In | Hotel Sri Batik</title>
      ...
      <nav class="navbar">
        ...
        <main>
            ...
            <div class="wrapper">
                ...
                <form action="checkin_function.php" method="POST" class="form">
                   <div class="inputfield">
                      <label>Name</label>
                      <input type="text" class="input" name="custName" required>
                   </div>
                   <div class="inputfield">
                      <label>Phone Number</label>
                      <input type="text" class="input" name="custNumber" required>
                   </div> 
                  <div class="inputfield">
                      <label>Address</label>
                      <textarea class="textarea" name="custAddress" required></textarea>
                      
                   </div> 
                    <div class="inputfield">
                      <label>Email Address</label>
                      <input type="text" class="input" name="custEmail" required>
                   </div>  
                  <div class="inputfield">
                      <label>Period of Stay</label>
                      <input type="number" class="input" min="1" name="custPeriod" required>
                   </div> 
                  <div class="inputfield">
                      <label>Gender</label>
                      <input type="radio" class="input" name="custGender" value="MALE" id="male" required>Male
                      <input type="radio" class="input" name="custGender" value="FEMALE" id="female" required>Female
                   </div> 
                   <div class="inputfield">
